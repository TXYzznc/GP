...
1. **Codex 内置 `WebSearch`**：Codex 原生模型的默认搜索工具
...
| 搜索方式         | 工具                                 | 特点                   |
| ---------------- | ------------------------------------ | ---------------------- |
| **WebSearch**    | Codex 内置                          | 搜索质量高、结果更相关 |
...
- 搜索时间：2026-01-21
- 关键词：Codex AI 最新功能, Codex AI 更新, Codex 3.5 特性
- 结果数量：28 条（去重后）

## 核心发现

### 1. Codex 3.5 Sonnet 发布

Anthropic 于 2025 年发布了 Codex 3.5 Sonnet，在代码生成和长文本理解方面有显著提升。

> 来源：[Anthropic Blog - Codex 3.5](https://anthropic.com/blog/...)
...
1. [Anthropic Blog - Codex 3.5](https://anthropic.com/blog/...)
2. [TechCrunch: Codex gets major update](https://techcrunch.com/...)

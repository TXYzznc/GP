...
using TMPro;
public partial class BattlePresetUI
{
	[Space(10)]
	[Header("UI Variables:")]
	[SerializeField] private Button varBtnBack = null;
	[SerializeField] private Button varBtnSave = null;
	[SerializeField] private Button varBtnDelete = null;
	[SerializeField] private Button varBtnSetDefault = null;
	[SerializeField] private Button varBtnReset = null;

...
public class SceneDependencyAnalyzer : EditorWindow
{
    private Object sceneAsset;
    private string targetFolder = "Assets/AAAGame/SceneAssets";
    ...
    {
        var window = GetWindow<SceneDependencyAnalyzer>("场景依赖分析器");
    ...
    private void DrawToolbar()
    {
        ...
        if (GUILayout.Button("浏览", GUILayout.Width(50)))
        {
            ...
            {
                targetFolder = "Assets" + selected[(selected.IndexOf("Assets") + 6)..];
            }
        }
        EditorGUILayout.EndHorizontal();
    }
    ...
    private void ExportReport()
    {
        ...
        string outputPath = "Assets/AAAGame/SceneDependencyReport.txt";

...
public class TreasureBoxSpawnPointBatchCreator : EditorWindow
{
    ...
    [MenuItem("Window/TreasureBox Spawn Point Batch Creator")]
    private static void ShowWindow()
    {
        GetWindow<TreasureBoxSpawnPointBatchCreator>("TreasureBox Spawn Creator");
    }

    private void OnGUI()
    {
        GUILayout.Label("宝箱生成点批量创建器（全场景 NavMesh 智能生成）", EditorStyles.boldLabel);
    ...
    private void GenerateSpawnPoints()
    {
        ...
        EditorUtility.DisplayDialog("成功", $"已生成 {selectedPoints.Count} 个宝箱 SpawnPoint（设置数量: {m_Count}）", "确定");
        Debug.Log($"已批量生成 {selectedPoints.Count} 个 TreasureBoxSpawnPoint");
    }
